 ...
 * php code///////////**********************************************************
 */
$title = 'ระบบจัดการข้อมูลแอปพพลิเคขัน : ผู้ใช้';
$db = new database();
$option_user = array(
    "table" => "admin",
...
<div id="page-warpper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><font size="5"><font color="#000">จัดการผู้ใช้</font></font></h1>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="subhead">
                ...
                <a role="button" class="btn btn-default btn-xs" 
                   href="<?php echo $baseUrl; ?>/back/admin">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="search-form" style="display:none">
                ...
                <form id="yw0" action="<?php echo $baseUrl; ?>/back/admin/index" method="get"><div class="form-horizontal" style="margin-top: 10px;">
