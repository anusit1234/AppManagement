    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-horizontal" style="margin-top: 10px;">
                <form id="user-form" action="<?php echo $baseUrl; ?>/back/admin/form_changepassword/<?php echo $rs_user['id']; ?>" method="post">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="subhead">
                ...
                &nbsp;&nbsp;&nbsp;
                <a role="button" class="search-button btn btn-default btn-xs" href="<?php echo $baseUrl; ?>/back/admin">
