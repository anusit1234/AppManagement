 ...
 * php code///////////**********************************************************
 */
$title = 'ระบบจัดการข้อมูลแอปพลิเคชัน : หมวดหมู่รายจ่ายคงที่';
$db = new database();
$pagination = new Zebra_Pagination();

$sql_pc = "SELECT * FROM fixed_expenses_categories WHERE 1=1 ";
...
<div id="page-warpper">
    <div class="row">
        ...
        <!-- <i class="glyphicon glyphicon-plus-sign">เพิ่มหมวดหมู่</i> -->
    </div>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="submit">
                    ...
                    <a role="button" class="btn btn-default btn-xs" href="<?php echo $baseUrl; ?>/back/fixed_expenses_categories">
        ...
        <div class="col-lg-12">
            <div class="subhead">
                <!-- <a role="button" class="btn btn-success btn-xs new-data"
                   href="<?php echo $baseUrl; ?>/back/fixedExpensesCategorie/create">
                ...
                <!--<a role="button" class="btn btn-default btn-xs"
                   href="<?php echo $baseUrl; ?>/back/fixedExpensesCategorie">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="search-form" style="display:none">
                ...
                <form id="yw0" action="<?php echo $baseUrl; ?>/back/fixed_expenses_categories/index" method="get">
                    <div class="form-horizontal" style="margin-top: 10px;">
                        <div class="form-group">
                            <label for="name" class="col-sm-2 control-label">ชื่อหมวดหมู่รายจ่ายคงที่</label>
                            <div class="col-sm-4">
                    ...
                    <tbody>
                        ...
                        while ($rs_pc = $db->get($query_pc_page)) {
                            ...
                            <tr class="<?php echo $tr; ?>">
                                <!-- <td>
                                    <a class="load_data" href="<?php echo $baseUrl; ?>/back/fixedExpensesCategorie/update/<?php echo $rs_pc['id']; ?>"><?php echo $rs_pc['id']; ?></a>
                                </td> -->
                                <td>
                                    <a class="load_data" href="<?php echo $baseUrl; ?>/back/fixed_expenses_categories/update/<?php echo $rs_pc['id']; ?>"><?php echo $rs_pc['name']; ?></a>
                                </td>
                                <td><?php echo date("d/m/Y", strtotime($rs_pc['created']));?></td>
                                <!--<td><?php echo $rs_pc['codename']; ?></td>-->
  <!--                              <td><?php echo thaidate($rs_pc['created']); ?></td>-->
                                <td class="button-column">
                                    <a class="btn btn-warning btn-xs load_data" title="" href="<?php echo $baseUrl; ?>/back/fixed_expenses_categories/update/<?php echo $rs_pc['id']; ?>"><i class="glyphicon glyphicon-edit"></i> แก้ไข</a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a role="button" class="btn btn-primary" href="<?php echo $baseUrl; ?>/back/fixed_expenses_categories/delete/<?php echo $rs_pc['id']; ?>">ใช่ ยืนยันการลบ</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
