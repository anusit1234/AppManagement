...
<div id="page-warpper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><font size="5"><font color="#000">จัดการหมวดหมู่รายรับ</font></font></h1>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="search-form" style="display:none">
                ...
                <form id="yw0" action="<?php echo $baseUrl; ?>/back/incomeCategorie/index" method="get">
...
<!--                            <th id="user-grid_c4">
  ...
  <!--                              <td><?php echo thaidate($rs_pc['created']); ?></td>-->
                                <td class="button-column">
                                    <a class="btn btn-warning btn-xs load_data" title="" href="<?php echo $baseUrl; ?>/back/incomeCategorie/update/<?php echo $rs_pc['id']; ?>"><i class="glyphicon glyphicon-edit"></i> แก้ไข</a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a role="button" class="btn btn-primary" href="<?php echo $baseUrl; ?>/back/incomeCategorie/delete/<?php echo $rs_pc['id']; ?>">ใช่ ยืนยันการลบ</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
