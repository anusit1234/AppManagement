...
$sql = "SELECT t2.name as categoryExp, t3.name as channelExp, t1.amount, t1.created
            FROM daily_expenses t1 inner join daily_expenses_categories t2 on t1.daily_expenses_cate_id = t2.id
                    ...
                    WHERE t1.user_id = '$id' and t2.status ='0' and  MONTH(t1.created)='$month' order by t1.created DESC
            ";
